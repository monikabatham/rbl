...
<style>.nav-pills > li.active > a, .nav-pills > li.active > a:focus, .nav-pills > li.active > a:hover {color: #267bda;}</style>
</head>
...
<li><a href="//bt.konicaminolta.in/career/admin/newjob.php">Add Job</a></li>
<li><a href="//bt.konicaminolta.in/career/admin/list_jobs.php">Jobs</a></li>
<li class="active"><a href="https://bt.konicaminolta.in/career/admin/applications.php">Applications</a></li>
...
<div class="col-md-12 table-bordered">
<div class="bg-primary page-title row"><span></span>Applications</div> 
<div class="main-content table-responsive">
<div style="padding:10px">
<form method="post" action="https://bt.konicaminolta.in/career/admin/applications.php">
...
$query ="SELECT * FROM `career_applicant_list` where ((Position LIKE '%" . $keyword . "%' OR experience LIKE '%" . $keyword . "%' OR current_ctc LIKE '%" . $keyword . "%' OR Location LIKE '%" . $keyword . "%') AND (A_type='1')) ORDER BY id DESC";
//$result = mysqli_query($query)or die(mysqli_error());
$result = $conn->query($query);
//$num_row = mysqli_num_rows($result);

echo '<table id="mytable" class="table table-bordered" style="font-size:11px !important">
<tr class="table-bg">
...
?>
<tr class="testpag">
<td><span class="job-title"><?php echo $row['Jobid']; ?> - <?php echo $row['Position']; ?></span></td>
...
<td><a target="_blank" href="//bt.konicaminolta.in/career/uploads/<?php echo $row['CV_name']; ?>"><u>Download</u></a></td>
</tr>
<?php } }else{ echo "<span style='color:red;padding-top: 10%;position: absolute;'>"."Results Not Found!"."</span>";}?>
</table>
<?php
}else{

$query = "SELECT * FROM `career_applicant_list` where A_type='1' ORDER BY id DESC";
$result = $conn->query($query);
