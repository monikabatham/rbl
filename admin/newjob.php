...
$sql_req = mysqli_query($con,"INSERT INTO `career_job_details` SET Title = '$title',Function = '$function',Qualification = '$qulification',Skills = '$skills',Experience = '$experience',Salary = '$salary',Description = '$description',Post_Date = '$start_date',Create_Date = now()" );
echo $sql_req;
If($sql_req){
$sql = mysqli_query($con,"SELECT * FROM career_job_details WHERE id=(SELECT MAX(id) FROM career_job_details)" );
...
{
$request = mysqli_query($con,"INSERT INTO `career_job_list` SET Job_id = '$ID',Function = '$function',Status = '1',location = '$loc'" );
}
...
<li class="active"><a href="//bt.konicaminolta.in/career/admin/newjob.php">Add Job</a></li>
<li><a href="//bt.konicaminolta.in/career/admin/list_jobs.php">Jobs</a></li>
<li><a href="//bt.konicaminolta.in/career/admin/applications.php">Applications</a></li>
<li><a href="//bt.konicaminolta.in/career/admin/applications-without-opening.php">Application Without Opening</a></li>
</ul>
</div>
</div> 
</div>
...
<form class="form-horizontal main-content" action="//bt.konicaminolta.in/career/admin/newjob.php" method="post">
